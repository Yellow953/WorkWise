                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="position"
                                        value="{{ old('position') }}" required placeholder="Position..." />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="industry"
                                        value="{{ old('industry') }}" placeholder="Industry..." required />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="experience_level">
                                        <option value="training" {{old('experiecne_level')=='training' ? 'selected' : ''
                                            }}>Training</option>
                                        <option value="junior" {{old('experiecne_level')=='junior' ? 'selected' : '' }}>
                                            Junior</option>
                                        <option value="senior" {{old('experiecne_level')=='senior' ? 'selected' : '' }}>
                                            Senior</option>
                                    </select>
                                </div>
                            </div>
